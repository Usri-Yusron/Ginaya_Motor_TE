    ...
    <div class="d-flex flex-column h-100">
        ...
        <div class="px-4 py-4 border-bottom">
            <div class="d-flex align-items-center gap-2">
                <div class="rounded-circle d-flex align-items-center justify-content-center"
                    style="width: 40px; height: 40px; background: linear-gradient(45deg, #0e7490, #0891b2);">
                    <i class="bi bi-shop-window text-white fs-5"></i>
                </div>
                <div class="sidebar-text">
                    <h2 class="fs-5 fw-bold mb-0 text-teal-500">Store Admin</h2>
        ...
        <div class="border-top p-3">
            <div class="d-flex align-items-center gap-3">
                ...
                @endphp
                <div class="rounded-circle bg-teal-500 d-flex align-items-center justify-content-center"
