    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-custom">
        <div class="w-full max-w-md mx-auto p-6">
            ...
            <div class="mb-12 text-center">
                <div
                    class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-teal-500 to-teal-600 rounded-2xl flex items-center justify-center">
            ...
            <p class="mt-8 text-center text-secondary">
                ...
                <a href="{{ route('login') }}" class="text-accent font-medium hover:text-teal-700">Sign in</a>
            </p>
        </div>
    </div>
