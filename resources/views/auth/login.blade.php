    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-custom">
        <div class="w-full max-w-md mx-auto p-6">
            ...
            <div class="mb-12 text-center">
                <div
                    class="w-16 h-16 mx-auto mb-6 bg-gradient-to-r from-teal-500 to-teal-400 rounded-2xl flex items-center justify-center">
                ...
                <form class="space-y-6" action="{{ route('auth.login') }}" method="POST">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="remember" id="remember"
                            class="w-5 h-5 border-2 border-gray-300 rounded-lg text-teal-500 focus:ring-teal-500 mr-3">
                        <label for="remember" class="text-sm text-secondary select-none">Keep me signed in</label>
                    </div>
            ...
            <p class="mt-8 text-center text-secondary">
                ...
                <a href="{{ route('register') }}" class="text-accent font-medium hover:text-teal-700">Create Account</a>
            </p>
        </div>
    </div>
