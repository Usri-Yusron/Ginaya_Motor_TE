...
class ShoppingCart {
    ...
    updateOrderSummary(subtotal, shipping) {
        ...
        if (elements.checkout) {
            ...
            elements.checkout.className = isDisabled
                ...
                : 'mt-6 w-full bg-orange-600 text-white py-3 px-4 rounded-lg hover:bg-orange-700';
        }
    }
    ...
    // Proses awal inisiasi pembayaran
    async initiatePayment() {
        ...
        try {
            // Panggil endpoint proses checkout yang akan mengirimkan OTP via email
            ...
            // Tampilkan notifikasi bahwa OTP telah dikirim
            this.showNotification(data.message || 'Kode OTP telah dikirim ke email Anda');

            // Tampilkan modal OTP untuk verifikasi
            this.otpModal.show(data.temp_order_id, (snapToken, orderId) => {
                this.handlePayment(snapToken, orderId, payButton);
            });
            ...
            <form id="checkoutForm" class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="${name}"
                           ...
                           focus:border-orange-500 focus:ring-orange-500" required>
                </div>
                <div>
    ...
    showNotification(message, type = 'success') {
        ...
        notification.className = `fixed bottom-4 right-4 px-6 py-3 rounded-lg shadow-lg 
            ...
            ${type === 'success' ? 'bg-orange-500' : 'bg-red-500'} text-white`;
